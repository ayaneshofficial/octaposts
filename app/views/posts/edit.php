<?php require APPROOT . '/views/inc/header.php'; ?>
  ...
  <div class="container">
    <div class="card shadow bigMarg">
      <div class="card-header bg-green text-white card-border">Edit Your Post</div>
      <div class="card-body borderTop">
        <form action="<?php echo URLROOT; ?>/posts/edit/<?php echo $data['id'] ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="custom-file mb-4">
            ...
            <label for="cover_image" class="custom-file-label greenBorder">Choose A New Image (JPG, JPEG, PNG)</label>
