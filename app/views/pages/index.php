<?php require APPROOT . '/views/inc/header.php'; ?>
  <div id="index">
    <nav class="navbar navbar-expand-sm navbar-dark bg-trans mb-3 py-2">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="<?php echo URLROOT; ?>/actions/login" class="btn success-btn"><span><i class="fa fa-user-circle mr-1"></i></span> Sign In</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-between align-items-center">
        <div class="col-md-5 mb-5 d-none d-lg-block">
          <span class="d-block text-white text-uppercase mb-3 lp-2 fw-7">Have A Switch!</span>
        ...
        <div class="col-md-5 mb-5">
          <div class="card bg-light p-3 card-form">
            <div class="card-body">
              <h3 class="fw-4 mb-4">Get Started For Free</h3>

              <form action="<?php echo URLROOT; ?>/pages/index" method="post">
                <div class="form-group mb-4">
                  <input type="text" name="name" class="form-control form-border p-3 <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?>" 
                ...
                <div class="form-group mb-4">
                  <input type="password" name="confirm_password" class="form-control form-border p-3 <?php echo (!empty($data['confirm_password_err'])) ? 'is-invalid' : ''; ?>" 
                  value="<?php echo $data['confirm_password']; ?>" placeholder="Confirm Password">
